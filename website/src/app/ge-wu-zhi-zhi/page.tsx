...
export default async function GeWuZhiZhi() {
  const dirPath = path.join(process.cwd(), 'public/research');
  let posts: any[] = [];
      ...
      <div className="max-w-2xl mx-auto py-12">
        ...
        <header className="mb-16">
          ...
          <p className="text-slate-500 text-lg">
            Exploring the essence behind things, recording cross-disciplinary thinking and technical deep dives.
          </p>
        </header>

        <div className="space-y-16">
          {posts.length === 0 ? (
            <p className="text-slate-500">No posts found in public/research/</p>
          ) : (
            posts.map(post => (
