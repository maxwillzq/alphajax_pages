...
date: "2026-04-26"
description: 本报告对 Vistra Corp (VST) 进行深度量化分析，揭示其在 AI 衍生电力需求下的爆发潜力，分析 5月15日大单期权异动，并提供具体的 Short Put 策略。
---
...
*   **支撑与阻力位分析**：
    *   **短期支撑**：**$156.67**（20日均线）及 **$139.73**（20日低点）。
    *   **短期阻力**：**$167.45**（20日高点）。
    *   **中期支撑**：**$161.25**（50日均线）及 **$112.15**（60日低点）。
    *   **中期阻力**：**$181.99**。
    *   **长期支撑**：**$105.00**。
    *   **长期阻力**：**$185.00**（6个月高点）。
*   **筹码分布 (Volume Profile) 分析**：
    *   **控制点 (POC)**：**$164.52**，与当前股价几乎重合，表明目前处于筹码最密集的“战场”区域。
    *   **高成交量区 (HVN) 支撑**：下方强支撑位在 **$158.65**。

## 8. 🌊 期权异动与大单追踪
*   **最新期权快照 (数据日期: 2026-04-26)**：
    *   **成交量 Call/Put 比例**：**1.33**。显示短期内看涨期权成交活跃。
    *   **未平仓 (OI) Call/Put 比例**：**0.89**。显示历史沉淀的 Put 头寸较多。
    *   **Call 端异动**：发现 **2026-05-15 到期的 $180 行权价 Call** 成交量巨大 (3310)，且未平仓合约高达 7311。同时，**$210 行权价的 Call** 也有显著成交 (2505)。
    *   **Put 端异动**：发现 5月15日到期的价外 Put 成交活跃。其中 **$145 Put** 成交量达 **727** 张，**$150 Put** 成交量达 **433** 张，显示出部分资金在这些位置进行防守或积极卖出赚取高额权利金。
*   **深度解析与机构意图**：
...
*   **期权策略**：
    ...
    *   **收益增强 (Short Put)**：鉴于财报前隐含波动率（IV）极高，5月15日到期的 **$150 Put** 权利金已推高至约 **$4.47**（提供约 3% 的 3周期回报）。稳健投资者可考虑在 **$150 或 $145** 处卖出价外 Put，既能获取丰厚权利金，又能以更低的价格（若被行权）低吸优质资产。
